...
import { AlignJustify, MenuSquare } from "lucide-react";
import AvatarComponets from "../avatar";
import { useCallback, useState } from "react";
import MenuItem from "./menueItems";
...
const UserMenue: React.FC<UserMenueProps> = ({
    currentUser
}) => {
    ...
    return ( 
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
                ...
                <div onClick={togleOpen} className="p-4 md:py-1 md:px-2 border-[1px] border-neutral-200 flex flex-row items-center gap-3 rounded-full cursor-pointer hover:shadow-md transition">
                <AlignJustify />
                <div className="hidden md:block">
                    <AvatarComponets src={currentUser?.image} />
                </div>
                </div>
            </div>
